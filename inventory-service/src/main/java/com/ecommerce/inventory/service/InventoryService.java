...
public class InventoryService {
 ...
 public InventoryService(InventoryRepository repo,KafkaTemplate<String,Object> kafka){this.repo=repo;this.kafka=kafka;}

 public Inventory create(InventoryRequest r){
   Inventory i=repo.findByProductId(r.productId()).orElseGet(Inventory::new);
   i.setProductId(r.productId()); i.setAvailableQuantity(r.quantity()); return repo.save(i);
 }
